...
function measure(id) {
  ...
  var top = elementData.dom.offsetTop;
  var bottom = top + elementData.dom.offsetHeight;
  var left = elementData.dom.offsetLeft;
  var right = left + elementData.dom.offsetWidth;
