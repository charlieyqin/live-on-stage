...
exports.manuallyCheckAll = manuallyCheckAll;
exports.manuallyMeasureAll = manuallyMeasureAll;
...
function manuallyCheckAll() {
  if (viewport) {
    requestAnimationFrame(checkAll);
  }
}

function manuallyMeasureAll() {
  if (viewport) {
